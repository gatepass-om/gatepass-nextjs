...
const navigationItems: NavigationItem[] = [
  { href: '/dashboard', label: 'Dashboard', group: 'Operations', roles: ['Admin', 'Operator Admin', 'Manager', 'Supervisor', 'Consultant', 'Contractor Admin'] },
  { href: '/access-requests', label: 'Access Requests', group: 'Operations', roles: ['Admin', 'Operator Admin', 'Manager', 'Worker', 'Supervisor', 'Contractor Admin', 'Consultant'] },
  ...
  { href: '/projects', label: 'Projects', group: 'Governance', roles: ['Admin', 'Operator Admin', 'Manager', 'Supervisor', 'Contractor Admin', 'Consultant'] },
  ...
  { href: '/users', label: 'Personnel', group: 'Directory', roles: ['Admin', 'Operator Admin', 'Contractor Admin', 'Manager', 'Supervisor', 'Consultant'] },
  ...
  { href: '/notifications', label: 'Notifications', group: 'Account', roles: ['Worker', 'Visitor', 'Manager', 'Supervisor', 'Admin', 'Operator Admin', 'Security', 'Contractor Admin', 'Consultant', 'Inspector'] },
];
